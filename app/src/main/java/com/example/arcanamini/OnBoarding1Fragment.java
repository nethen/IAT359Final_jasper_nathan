...
public class OnBoarding1Fragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getStartedButton = v.findViewById(R.id.onboarding1Button);
    ...
    public void onClick(View view) {
        if(view == view.findViewById(R.id.onboarding1Button)){
            FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
            fragmentManager.beginTransaction()
                    .replace(R.id.onboard_fragment_container, OnBoarding2Fragment.class, null)
